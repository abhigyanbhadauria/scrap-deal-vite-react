...
export default function AccountPage({ onLogout }) {
  ...
  useEffect(() => {
    ...
    fetch(`${API_BASE_URL}/api/scrap/my?phone=${phone}`)
      .then((res) => res.json())
  ...
  useEffect(() => {
    ...
    fetch(`${API_BASE_URL}/api/malwa/my?phone=${phone}&name=${user.name}&email=${user.email}`)
      .then((res) => res.json())
  ...
  useEffect(() => {
    ...
    fetch(`${API_BASE_URL}/api/dealer/my/${phone}`)
